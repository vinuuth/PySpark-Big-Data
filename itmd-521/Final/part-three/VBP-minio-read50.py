...
spark = SparkSession.builder.appName("VBP-minio-read-and-process-50").config('spark.driver.host','spark-edge-vm0.service.consul').config(conf=conf).getOrCreate()
...
#splitDF.write.csv("s3a://vbengaluruprabhudev/40-csv")
