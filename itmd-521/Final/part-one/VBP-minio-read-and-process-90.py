...
spark = SparkSession.builder.appName("VBP-minio-read-and-process-90").config('spark.driver.host','spark-edge-vm0.service.consul').config(conf=conf).getOrCreate()
...
splitDF.write.parquet("s3a://vbengaluruprabhudev/90-parquet")
splitDF.write.csv("s3a://vbengaluruprabhudev/90-csv")
