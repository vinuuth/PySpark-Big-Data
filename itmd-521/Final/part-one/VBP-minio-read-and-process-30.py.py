...
# Write as csv
splitDF.write.format("csv").mode("overwrite").option("compression", "none").save("s3a://vbengaluruprabhudev/30-csv")
# Write as json
splitDF.write.format("json").mode("overwrite").option("compression", "none").save("s3a://vbengaluruprabhudev/30-json")
# Write as csv lz4 compression
splitDF.write.format("csv").mode("overwrite").option("compression", "lz4").save("s3a://vbengaluruprabhudev/30-lz4-compression")
# Write as Parquet
splitDF.write.format("parquet").mode("overwrite").parquet("s3a://vbengaluruprabhudev/30-parquet")
# Write csv with single parttion
splitDF = splitDF.coalesce(1)
splitDF.write.csv("s3a://vbengaluruprabhudev/30-single-part-csv")


#splitDF.write.parquet("s3a://vbengaluruprabhudev/30-parquet")
#splitDF.write.csv("s3a://vbengaluruprabhudev/30-csv")
